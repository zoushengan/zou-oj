...
import com.example.oj.model.dto.question.QuestionQueryRequest;
...
* @createDate 2024-03-31 12:25:27
*/
@Service
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    public void validQuestion(Question question, boolean add) {
        ...
        String juageCase = question.getJuageCase();
        String juageConfig = question.getJuageConfig();
        // 创建时，参数不能为空
        if (add) {
        ...
        if (StringUtils.isNotBlank(juageCase) && juageCase.length() > 8192) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "判题用例过长");
        }
        if (StringUtils.isNotBlank(juageConfig) && juageConfig.length() > 8192) {
